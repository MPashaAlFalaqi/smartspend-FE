...
export default function AdminDashboard() {
  ...
  // State aman untuk menyimpan data Admin yang sedang login
  ...
  // Mengambil data admin secara otomatis saat halaman dimuat
  ...
  // Pembuat inisial nama otomatis untuk avatar lingkaran kuning
  ...
  const getInitials = (fullName) => {
    ...
    return names[0][0].substring(0, 2).toUpperCase()
