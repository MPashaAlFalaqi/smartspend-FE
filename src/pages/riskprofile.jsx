...
export default function RiskProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        // Simpan data ke localStorage agar dibaca oleh halaman lainnya
        ...
        // Langsung update state lokal agar nama di pojok kanan ikut berubah detik itu juga
        ...
        <div style={{ maxWidth:'740px', margin:'0 auto', padding:'48px 24px' }}>
          ...
          <div style={{ 
            ...
            <form onSubmit={handleSubmit} style={{ textAlign:'left' }}>
              ...
              >
                {sukses ? 'Memproses Analisis...' : 'Simpan Profil Risiko & Lanjutkan →'}
              </button>
