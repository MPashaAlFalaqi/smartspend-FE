...
export default function Dashboard() {
  ...
  // Langsung ambil nama & email dari localStorage agar tidak berkedip tulisan "User"
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        // Ambil cadangan lokal awal untuk mencegah fallback kosong jika server bermasalah
            ...
            <div style={{ position:'relative' }}>
              ...
              {showDropdown && (
                <div style={{ position:'absolute', right:0, top:'48px', backgroundColor:'white', borderRadius:'14px', boxShadow:'0 8px 32px rgba(0,0,0,0.15)', width:'220px', padding:'8px', zIndex:200 }}>
                  ...
                  {/* FIXED: Mengubah route ke /user-profile agar sesuai dengan file konfigurasi App.jsx */}
